...
5. Open the project in VSCode, launch the terminal and link the project to the
   ...
   instructions](https://docs.github.com/en/get-started/getting-started-with-git/managing-remote-repositories#changigit
   remote set-url originng-a-remote-repositorys-url).
